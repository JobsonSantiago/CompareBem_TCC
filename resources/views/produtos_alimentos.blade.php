...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6 col-12 mb-3">
        <div class="circle">
            <a href="cremedeleite">
                <img src="images/pd_cremeleite_tcc.png" alt="Creme de Leite">
            </a>
        </div>
    ...
    <div class="col-lg-4 col-md-6 col-12 mb-3">
        <div class="circle">
            <a href="molhodetomate">
                <img src="images/pd_molhotomate_tcc.png" alt="Molho de Tomate">
            </a>
        </div>
    ...
    <div class="col-lg-4 col-md-6 col-12 mb-3">
        <div class="circle">
            <a href="leitecondensado">
                <img src="images/pd_leitecondensado_tcc.png" alt="Leite Condensado">
            </a>
        </div>

            ...
            <div class="row" id="produtos-container">
                <div class="col-lg-4 col-md-4">
                    <div class="product-card">
                        <img src="images/pr_macarrao.png" alt="Imagem do Produto 1">
                        <div class="product-info">
                            ...
                            <form action="{{ route('avaliacao_produto') }}" class="d-inline" method="POST">
                                <input type="hidden" name="id_produto" value="11"> <!-- ID do produto -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_macarrao.png" alt="Imagem do Produto 2">
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produto" value="11">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_macarrao.png" alt="Imagem do Produto 3">
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produto" value="11">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_macarrao.png" alt="Imagem do Produto 4">
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produto" value="11">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_macarrao2.png" alt="Imagem do Produto 5">
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                            ...
                            <br>
                            <p class="product-name">Massa de Sêmola Espaguete 8 Adria 500 g</p>
                            @php
                            // apresentando a media de preços
                            $precomedio = App\Models\ProdutosCaracteristicas::where('id_mercado', 1) // ID do mercado
                            ->where('id_produto', 12) // ID do produto
                            ->avg('preco');
                            ...
                            <p class="product-review-label">Avalie a veracidade do preço do produto:</p>
                            <form action="{{ route('avaliacao_produto') }}" class="d-inline" method="POST">
                                <input type="hidden" name="id_produto" value="12"> <!-- ID do produto -->
                                <input type="hidden" name="id_mercado" value="1"> <!-- ID do mercado -->
                                @csrf
                                <div class="input-group input-group-sm">
                                    <select name="avaliacao_preco" class="form-select" aria-label="Default select example">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_macarrao2.png" alt="Imagem do Produto 6">
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produto" value="12">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_macarrao2.png" alt="Imagem do Produto 7">
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produto" value="12">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_macarrao2.png" alt="Imagem do Produto 8">
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produto" value="12">

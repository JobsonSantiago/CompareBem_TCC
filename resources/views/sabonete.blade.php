            ...
            <div class="row" id="produtos-container">
                <div class="col-lg-4 col-md-4">
                    <div class="product-card">
                        <img src="images/pr_sabonete.png" alt="Imagem do Produto 1"> <br><br>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_sabonete.png" alt="Imagem do Produto 2"> <br><br>
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produto" value="29">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_sabonete.png" alt="Imagem do Produto 3"> <br><br>
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produto" value="29">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card">
                        <img src="images/pr_sabonete.png" alt="Imagem do Produto 4"> <br><br>
                        <div class="product-info">
                            <form action="{{ route('favoritar') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produto" value="29">

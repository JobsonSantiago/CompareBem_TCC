    ...
    <div class="container mt-5">
        ...
        <div class="row" id="produtos-container">
            <div class="col-lg-4 col-md-4">
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        ->where('id_produto', 9) // ID do produto
                        ->exists();
                        @endphp
                        ...
                        <br>
                        <p class="product-name">Café Pilão Torrado E Moído Tradicional Almofada 500g</p>
                        @php
                        ...
                        <form action="{{ route('avaliacao_produto') }}" class="d-inline" method="POST">
                            <input type="hidden" name="id_produto" value="9"> <!-- ID do produto -->
            ...
            <div class="col-lg-4 col-md-6">
                <div class="product-card">
                    <img src="images/pr_cafe.png" alt="Imagem do Produto 2">
                    <div class="product-info">
                        @php
                        // Verifique se o produto já foi favoritado
                        $favoritoExistente = \App\Models\Favorito::where('user_id', auth()->id())
            ...
            <div class="col-lg-4 col-md-6">
                <div class="product-card">
                    <img src="images/pr_cafe.png" alt="Imagem do Produto 3">
                    <div class="product-info">
                        @php
                        // Verifique se o produto já foi favoritado
                        $favoritoExistente = \App\Models\Favorito::where('user_id', auth()->id())
            ...
            <div class="col-lg-4 col-md-6">
                <div class="product-card">
                    <img src="images/pr_cafe.png" alt="Imagem do Produto 4">
                    <div class="product-info">
                        @php
                        // Verifique se o produto já foi favoritado
                        $favoritoExistente = \App\Models\Favorito::where('user_id', auth()->id())
            ...
            <div class="col-lg-4 col-md-6">
                <div class="product-card">
                    <img src="images/pr_cafe2.png" alt="Imagem do Produto 5">
                    <div class="product-info">
                        @php
                        // Verifique se o produto já foi favoritado
                        $favoritoExistente = \App\Models\Favorito::where('user_id', auth()->id())
                        ->where('id_mercado', 1) // ID do mercado
                        ->where('id_produto', 10) // ID do produto
                        ->exists();
                        @endphp
                        <form action="{{ $favoritoExistente ? route('favoritar_remover') : route('favoritar') }}" method="POST"> @csrf
                        ...
                        <br>
                        <p class="product-name">Café Torrado e Moído Tradicional União 500g</p>
                        @php
                        // apresentando a media de preços
                        $precomedio = App\Models\ProdutosCaracteristicas::where('id_mercado', 1) // ID do mercado
                        ->where('id_produto', 10) // ID do produto
                        ...
                        <p class="product-review-label">Avalie a veracidade do preço do produto:</p>
                        <form action="{{ route('avaliacao_produto') }}" class="d-inline" method="POST">
                            <input type="hidden" name="id_produto" value="10"> <!-- ID do produto -->
                            <input type="hidden" name="id_mercado" value="1"> <!-- ID do mercado -->
                            @csrf
                            <div class="input-group input-group-sm">
                                <select name="avaliacao_preco" class="form-select" aria-label="Default select example">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="product-card">
                    <img src="images/pr_cafe2.png" alt="Imagem do Produto 6">
                    <div class="product-info">
                        @php
                        // Verifique se o produto já foi favoritado
                        $favoritoExistente = \App\Models\Favorito::where('user_id', auth()->id())
            ...
            <div class="col-lg-4 col-md-6">
                <div class="product-card">
                    <img src="images/pr_cafe2.png" alt="Imagem do Produto 7">
                    <div class="product-info">
                        @php
                        // Verifique se o produto já foi favoritado
                        $favoritoExistente = \App\Models\Favorito::where('user_id', auth()->id())
            ...
            <div class="col-lg-4 col-md-6">
                <div class="product-card">
                    <img src="images/pr_cafe2.png" alt="Imagem do Produto 8">
                    <div class="product-info">
                        @php
                        // Verifique se o produto já foi favoritado
                        $favoritoExistente = \App\Models\Favorito::where('user_id', auth()->id())
